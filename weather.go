...
func showWeatherApp(w fyne.Window){
	...
	res , err := http.Get("https://api.openweathermap.org/data/2.5/weather?q=new%20york&units=metric&APPID=98c874b438284f7137222e672eb56639")
	if err!= nil{
	...
	img:= canvas.NewImageFromFile("image2.png")
